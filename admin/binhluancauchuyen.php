<?php $title = "Bình luận về câu chuyện"; ?>
            ...
            <div class="card-body table-responsive">
                <table class="table table-striped table-hover" style="font-size: 13px">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT b.id AS bid, t.id AS tid, t.cauchuyen_tieude, u.name AS uname, b.binhluan_noidung, DATE_FORMAT(b.binhluan_ngay, '%d/%m/%y') AS date ";
                      ...
                      $query .= " ORDER BY {$order_by} ASC";
                          if ($result = $dbc->query($query)) {
                            while ($binhluan = $result->fetch_array(MYSQLI_ASSOC)) {
                              echo "
                                <tr>
                                  <td><a target='_blank' href='".BASE_URL."/chitietcauchuyen.php?id={$binhluan['tid']}'>".the_excerpt($binhluan['cauchuyen_tieude'], 50)."</a></td>
